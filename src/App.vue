<template>
  ...
  <div v-if="loggedIn" class="topbar">
    <div>
      <i class="fas fa-bars menu-icon" @click="showSidebar = !showSidebar"></i>
    </div>
    <div class="btn-group">
      <button
        type="button"
      ...
      <ul class="dropdown-menu">
        <li>
          <a class="dropdown-item" href="#" @click="go('ayuda')"
            ><i class="fas fa-question-circle"></i> Ayuda</a
          >
        </li>
        <li>
          <a class="dropdown-item" href="#" @click="go('configuracion')"
            ><i class="fas fa-user-cog"></i> Configuración</a
          >
        </li>
        <li><hr class="dropdown-divider" /></li>
        <li>
          <a class="dropdown-item" href="#" @click="go('cerrarSesion')"
  ...
  <div :class="{ layoutMain: loggedIn, layoutLogin: !loggedIn }">
    <div
      ref="mainLayout"
      :class="{ overlayMain: loggedIn, overlayLogin: !loggedIn }"
    >
